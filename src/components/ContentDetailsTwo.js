        ...
        <div>
            <div className="border-2 rounded-lg my-5">
                <div className="md:flex items-center">
                    <div className="h-36 md:h-56 relative md:w-1/2 flex justify-center items-center">
                        <img className="absolute object-cover w-full h-full" src="workout-plan.png" alt='' />
                    </div>
                    <div className="p-5 md:w-1/2 mx-auto">
            ...
            <div className="border-2 rounded-lg my-5 px-5">
                <div className="flex justify-between items-center">
                    ...
                    <div className="p-2 w-full text-center">
                        <h5 className='text-gray-300'>Speed Training Playlist</h5>
                        <p className='font-mini'>Get faster for any sport with these speed tips</p>
                    </div>
                    <BsChevronDown className='w-6 h-6 invisible' />
                </div>
            </div>
                ...
                <div className='py-3'>
                    <div className="flex justify-between items-center mb-6">
                        ...
                        <div className="p-2 mx-auto">
                            <h5 className='text-gray-300'>Workout Vlog With Batman!</h5>
                        </div>
            ...
            <div className="border-2 rounded-lg my-5 px-5">
                <div className='py-3'>
                    <div className="text-center mb-6">
                        <h5 className='text-gray-300'>Join the squad</h5>
                        <p className='font-mini'>Know when I drop merch & speed vlogs</p>
                    </div>
                    <div className=''>
                    ...
                    <div className="flex justify-center gap-5 my-4 font-mini w-full text-gray-300">
            ...
            <div className="border-2 rounded-lg my-5 px-5">
                <div className='py-5'>
                    <div className="flex justify-between items-center gap-2 mb-5">
                        <TiSocialYoutube className='w-6 h-6' />
                        <div className="">
                            <h5 className='text-gray-300 text-center'>Racing people for $$$</h5>
                        </div>
                        <BsChevronDown className='w-6 h-6' />
                    </div>
                    <div className=''>
                        <iframe className='w-full h-60 md:h-96' title='youtube-video' src="https://www.youtube.com/embed/RGj5K54dd58?mute=0&autoplay=0" allowFullScreen="allowfullscreen" allow="autoplay; fullscreen; picture-in-picture"></iframe>
                    </div>
                </div>
            </div>
        </div>
